...
?>
    ...
    <section class="declaration-statement section-white">
      <div class="container-fluid declaration-shell">
        <p class="section-kicker">Welcome home</p>
        <div class="declaration-statement__grid">
          <h2>A church for the curious, the committed, and everyone in between.</h2>
          <div class="declaration-statement__copy">
    ...
    <section id="visit" class="visit-editorial section-black">
      <div class="visit-editorial__image">
      ...
      <div class="visit-editorial__content">
...
<?php foreach ($next_steps as $step): ?>
          <a class="pathway-card" href="<?= htmlspecialchars($step['url']) ?>" target="_blank" rel="noopener">
...
<?php endforeach; ?>
    ...
    <section class="declaration-values section-black">
      <div class="container-fluid declaration-shell">
        <p class="section-kicker section-kicker--light">The kind of church we are becoming</p>
        <div class="values-list">
          <div><span>01</span><h3>Authenticity</h3><p>over appearance</p></div>
          <div><span>02</span><h3>Intimacy</h3><p>over intellect</p></div>
          <div><span>03</span><h3>Passion</h3><p>over performance</p></div>
          <div><span>04</span><h3>Kingdom</h3><p>over consumerism</p></div>
          <div><span>05</span><h3>Service</h3><p>over selfishness</p></div>
        </div>
    ...
    <section id="upcoming-events" class="events-editorial section-white">
      <div class="container-fluid declaration-shell">
        <div class="editorial-heading editorial-heading--compact">
          <div>
...
<?php endif; ?>
    ...
    <section id="contact" class="closing-invitation section-black">
      <div class="container-fluid declaration-shell">
        <p class="section-kicker section-kicker--light">See you Sunday</p>
        <h2>There is a<br>place for you.</h2>
        <div class="closing-invitation__details">
