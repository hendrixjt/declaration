...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    cms_verify_csrf();
    if (cms_login((string) ($_POST['username'] ?? ''), (string) ($_POST['password'] ?? ''))) {
        header('Location: /cms/');
        exit;
    }
    usleep(250000);
...
<head>
  ...
  <title>Sign in | Declaration CMS</title>
...
<body class="cms-auth">
  <main class="cms-auth__card">
    ...
    <p class="cms-eyebrow">Website administration</p>
    <h1>Welcome back.</h1>
    <p>Sign in to manage Declaration events.</p>
    ...
    <form method="post" class="cms-form">
      ...
      <button class="cms-button cms-button--primary" type="submit">Sign in</button>
    </form>
  </main>
</body>
</html>
